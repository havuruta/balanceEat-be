...
import com.balanceeat.demo.domain.auth.jwt.JwtAccessDeniedHandler;
import com.balanceeat.demo.domain.auth.jwt.JwtAuthenticationEntryPoint;
import com.balanceeat.demo.domain.auth.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.addExposedHeader("X-User-Profile");
